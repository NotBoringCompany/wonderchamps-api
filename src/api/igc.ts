...
/**
 * Adds claimable IGC to a user's account in the database (not Web3). 
 * This is usually called when the user doesn't have enough ETH to pay for gas fees to update their IGC in the Web3 account.
 * 
 * Claimable IGC in the database can be manually claimed by the user later once they have enough ETH to pay for gas fees.
 */
